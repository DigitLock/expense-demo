...
const (
	ExpenseService_AddExpense_FullMethodName   = "/expense.v1.ExpenseService/AddExpense"
	ExpenseService_ListExpenses_FullMethodName = "/expense.v1.ExpenseService/ListExpenses"
	ExpenseService_GetSummary_FullMethodName   = "/expense.v1.ExpenseService/GetSummary"
)
...
func (c *expenseServiceClient) GetSummary(ctx context.Context, in *SummaryRequest, opts ...grpc.CallOption) (*SummaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SummaryResponse)
	err := c.cc.Invoke(ctx, ExpenseService_GetSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExpenseServiceServer) GetSummary(context.Context, *SummaryRequest) (*SummaryResponse, error) {
...
func _ExpenseService_GetSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExpenseServiceServer).GetSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExpenseService_GetSummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExpenseServiceServer).GetSummary(ctx, req.(*SummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExpenseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ExpenseService_GetSummary_Handler,
		},
	},
